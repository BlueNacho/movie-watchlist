      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <button
                className="absolute top-1.5 right-2 z-10 flex h-7 w-7 items-center justify-center rounded-md border-2 border-theme-border bg-theme-surface font-bold text-theme-text hover:bg-theme-highlight transition-colors cursor-pointer"
              />
            }
          >
